import { catalogo } from "./dados.js"; // importa o catalogo de produtos
import { findProduto, carregaProduto, pegarCodProduto } from "./funcoes.js"; // importa as funcoes que serao executadas na pagina
...
let produto = findProduto(catalogo, id)// procura o produto pelo codigo no catalogo de produtos e guarda o resultado na variavel.
...
botaoComprar.addEventListener('click', ()=> {
    let quantidade = parseInt(document.querySelector("div.quantidade-prod input").value)
